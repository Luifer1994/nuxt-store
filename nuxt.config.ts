      ...
      meta: [
        {
          name: "description",
          content:
            "Bienvenido a Mi Tienda Nuxt 3, tu destino ideal para productos increíbles con grandes ofertas.",
        },
        {
          name: "keywords",
          content: "Nuxt, Vue, SEO, ecommerce, tienda en línea, ofertas",
        },
        { property: "og:title", content: "Mi Tienda Nuxt 3" },
        {
          property: "og:description",
          content:
            "Descubre productos increíbles y grandes ofertas en Mi Tienda Nuxt 3.",
        },
